...
public static class ModAssets_SoundEffect
{
    ...
    public static string cards_hitPath = "Sounds/cards_hit";
    ...
    public static string cards_release1Path = "Sounds/cards_release1";
    ...
    public static string cards_release2Path = "Sounds/cards_release2";
    ...
    public static string cards_release3Path = "Sounds/cards_release3";
    ...
    public static string cards_release4Path = "Sounds/cards_release4";
    ...
    public static string clocktowerPath = "Sounds/clocktower";
    ...
    public static string FireIgnitePath = "Sounds/FireIgnite";
    ...
    public static string FlameBarrier_EvokePath = "Sounds/FlameBarrier_Evoke";
    ...
    public static string LightningOrb_ChannelPath = "Sounds/LightningOrb_Channel";
    ...
    public static string LightningOrb_EvokePath = "Sounds/LightningOrb_Evoke";
    ...
    public static string LightningOrb_PassivePath = "Sounds/LightningOrb_Passive";
    ...
    public static string SOTE_SFX_BlockAtk_v2Path = "Sounds/SOTE_SFX_BlockAtk_v2";
    ...
    public static string SOTE_SFX_DefenseBreak_v2Path = "Sounds/SOTE_SFX_DefenseBreak_v2";
    ...
    public static string STS_VO_CrowCultist_1aPath = "Sounds/STS_VO_CrowCultist_1a";
    ...
    public static string weapon_sound8Path = "Sounds/weapon_sound8";
